(function(){
	...
	angular.module('whatscoreModule').controller('allfixturesCtrl',
    ['$scope','$http','$filter','$modal','fixturesFactory','$rootScope',function($scope, $http, $filter,$modal,fixturesFactory,$rootScope){

      $scope.currentPG = 5;

      $scope.changePage = function (newPageNumber) {
        $scope.currentPG = newPageNumber;
      }
